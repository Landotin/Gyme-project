...
public class gyme extends JFrame {
	...
	//ginawa kong pulic para maccess ng lahat
 ...
 public static void main(String[] args) {
   ...
   // Exercise labels and buttons
      ...
      exer1.setBounds(10, 30, 100, 30); // Adjusted position for visibility
      b_check1 = new JButton("✔");
      b_check1.setBounds(120, 30, 50, 30);
      b1 = new JButton("+");
      b1.setBounds(180, 30, 45, 30); // Adjusted button position
      count1 = new JLabel("0");
      ...
      pushUpProgress.setBounds(50, 310, 150, 30);

      JLabel pullUpProgress = new JLabel("Pull-Ups: 0");
      pullUpProgress.setBounds(50, 340, 150, 30);

      JLabel squatProgress = new JLabel("Squats: 0");
      squatProgress.setBounds(50, 370, 150, 30);

      JLabel sitUpProgress = new JLabel("Sit-Ups: 0");
      sitUpProgress.setBounds(50, 400, 150, 30);
      ...
      //Frame for inventory
      JFrame f_inventory;
      JButton head, torso, legs, feet, sword, shield, relic, rune,back;
      JLabel health, health_ind, dmg, dmg_ind, luck, luck_ind, armor, armor_ind;
     
      f_inventory = new JFrame();
      f_inventory.setTitle("Inventory");
      f_inventory.setSize(600, 1000);
      f_inventory.setVisible(false);
      f_inventory.setLayout(null);
     
      head = new JButton("Head");       
      head.setBounds(250, 80, 70, 40);
     
      torso = new JButton("Torso");       
      torso.setBounds(330, 80, 70, 40);
     
      legs= new JButton("Legs");       
      legs.setBounds(410, 80, 70, 40);
    
      feet = new JButton("Feet");       
      feet.setBounds(490, 80, 70, 40);
     
      sword = new JButton("Sword");       
      sword.setBounds(250, 140, 70, 40);
     
      shield= new JButton("Shield");       
      shield.setBounds(330, 140, 70, 40);
     
      relic = new JButton("Relic");       
      relic.setBounds(410, 140, 70, 40);
     
      rune = new JButton("Rune");       
      rune.setBounds(490, 140, 70, 40);
     
      back = new JButton("Go Back");       
      back.setBounds(490, 340, 90, 40);
     
     
      health = new JLabel("Health: ");
      health.setBounds(10, 180, 200, 50);
      health_ind = new JLabel("999/999");
      health_ind.setBounds(70, 180, 200, 50);
     
     
      dmg = new JLabel("Damage: ");
      dmg.setBounds(10, 220, 200, 50);
      dmg_ind = new JLabel("999/999");
      dmg_ind.setBounds(70, 220, 200, 50);
     
     
      luck = new JLabel("Luck: ");
      luck.setBounds(10, 260, 200, 50);
      luck_ind = new JLabel("999/999");
      luck_ind.setBounds(70, 260, 200, 50);
     
     
      armor = new JLabel("Armor: ");
      armor.setBounds(10, 300, 200, 50);
      armor_ind = new JLabel("999/999");
      armor_ind.setBounds(70, 300, 200, 50);
 
    
      f_inventory.add(head);
      f_inventory.add(torso);
      f_inventory.add(legs);
      f_inventory.add(feet);
      f_inventory.add(sword);
      f_inventory.add(shield);
      f_inventory.add(rune);
      f_inventory.add(relic);
      f_inventory.add(health);
      f_inventory.add(dmg);
      f_inventory.add(luck);
      f_inventory.add(armor);
      f_inventory.add(health_ind);
      f_inventory.add(luck_ind);
      f_inventory.add(dmg_ind);
      f_inventory.add(armor_ind);
